...
public class Trade implements IMessage {
    ...
    public Trade(String buyid, int buyOrderId, String sellid, int sellOrderId, double tradeprice, int tradevolume) {
        this.buyId = buyid;
